...
function listar(){
    ...
    //esconder sessao resultado e inserir
    section_resultado.style.display = "none";
    section_inserir.style.display = "none";
    //section listar deve estar visivel
    section_listar.style.display = "block";


    //fazer referencia a div chamada listarlivros para exibir os livros vindos da API
    ...
    .catch((erro)=>console.log(`Erro ao caregar os dados ${erro}`))
